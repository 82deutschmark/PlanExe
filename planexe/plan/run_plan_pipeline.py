...
class GovernancePhase2BodiesTask(PlanTask):
    ...
    def run_with_llm(self, llm: LLM) -> None:
        ...
        try:
            ...
            import time
            start_time = time.time()
            governance_phase2_bodies = GovernancePhase2Bodies.execute(llm, query, reasoning_effort=self.reasoning_effort)
            duration_seconds = time.time() - start_time
...
class GovernancePhase3ImplPlanTask(PlanTask):
    ...
    def run_with_llm(self, llm: LLM) -> None:
        ...
        try:
            ...
            import time
            start_time = time.time()
            governance_phase3_impl_plan = GovernancePhase3ImplPlan.execute(llm, query, reasoning_effort=self.reasoning_effort)
            duration_seconds = time.time() - start_time
...
class GovernancePhase5MonitoringProgressTask(PlanTask):
    ...
    def run_with_llm(self, llm: LLM) -> None:
        ...
        try:
            ...
            import time
            start_time = time.time()
            governance_phase5_monitoring_progress = GovernancePhase5MonitoringProgress.execute(llm, query, reasoning_effort=self.reasoning_effort)
            duration_seconds = time.time() - start_time
...
class GovernancePhase6ExtraTask(PlanTask):
    ...
    def run_with_llm(self, llm: LLM) -> None:
        ...
        try:
            ...
            import time
            start_time = time.time()
            governance_phase6_extra = GovernancePhase6Extra.execute(llm, query, reasoning_effort=self.reasoning_effort)
            duration_seconds = time.time() - start_time
